...
func _move(delta: float) -> void:
	...
	if direction and model_animation_tree["parameters/conditions/attacking"] == false:
		# Animations
		...
		if debug: print("Blend Position: " + str(animation_blend_position))
		...
		if debug: print("Moving with speed: " + str(final_speed))
		...
		if debug: print("Foward: " + str(camera_forward))
...
func _on_animation_tree_animation_finished(anim_name: StringName) -> void:
	if anim_name.contains("Attack"):
		if debug: print("Attacking Finished")
		model_animation_tree["parameters/conditions/attacking"] = false;
